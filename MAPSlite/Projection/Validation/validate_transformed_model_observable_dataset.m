function validate_transformed_model_observable_dataset(Model,Y)
% This helper validates a complete, transformed model observable dataset.
...
%
% DETAILS:  
%   -> This forecast macro helper validates that a complete model 
%      observable dataset does not contain non-real, inf (and -inf) or nan 
%      values. 
...
% nans). Pass in the mnemonic metadata name for model observables and the
...
validate_complete_model_dataset(Model,Y,'Ymnems',BadObsDataE);
